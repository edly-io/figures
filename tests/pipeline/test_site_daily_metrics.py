...
DEFAULT_START_DATE = datetime.datetime(2018, 1, 1, 0, 0, tzinfo=datetime.timezone.utc)
DEFAULT_END_DATE = datetime.datetime(2018, 3, 1, 0, 0, tzinfo=datetime.timezone.utc)
